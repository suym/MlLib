...
def main():
    ...
    if options == 'train':
        ...
        print'----------------------------------------------'
        dmp.Predict_test_data(xy_test, datavec_show_list, names_show, clf_model, dir_of_outputdata,'reg')
    ...
    if options == 'predict':
        ...
        dmp.Predict_data(raw_x, datavec_show_list, names_show, clf_model, dir_of_outputdata,'reg')
        duration = too.Duration(time()-time_start)
        print 'Total run time: %s'%duration
