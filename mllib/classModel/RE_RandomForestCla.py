...
def main():
    ...
    RE_RandomForestCla = name_dict['RE_RandomForestCla']
    n_estimators = RE_RandomForestCla['n_estimators']
    max_features = RE_RandomForestCla['max_features']
    ...
    if options == 'train':
        ...
        clf_model = mlp.RE_RandomForestClassifier(X_train, X_test, y_train, y_test, n_estimators, max_features)
        #保存模型参数
