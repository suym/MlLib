...
def main():
    ...
    model_name = 'GradientBoostingReg_huber'
    ...
    RE_GradientBoostingReg = name_dict['RE_GradientBoostingReg']
    n_estimators = RE_GradientBoostingReg['n_estimators']
    max_features = RE_GradientBoostingReg['max_features']
    ...
    if options == 'train':
        ...
        clf_model = mlp.RE_GradientBoostingRegressor(X_train, X_test, y_train, y_test, n_estimators, max_features)
        #保存模型参数
